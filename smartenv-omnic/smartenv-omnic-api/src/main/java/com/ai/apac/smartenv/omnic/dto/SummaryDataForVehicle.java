...
/**
 * @author qianlong
 * @description 每个租户的和车辆相关的各种数据汇总(按天统计)
 * @Date 2020/10/29 5:39 下午
 **/
@Data
@ApiModel
public class SummaryDataForVehicle implements Serializable {
    ...
    @ApiModelProperty("加水中数量")
    private Integer wateringCount;

    @ApiModelProperty("加油中数量")
    private Integer oilingCount;
