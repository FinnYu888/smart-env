...
@Component
@Slf4j
public class VehicleWorkStatusEvent extends BaseWebsocketPushStrategy<String> {
    ...
    public String getSupportEventType() {
        return WsMonitorEventConstant.EventType.VEHICLE_WORK_STATUS_EVENT;
    }
    ...
    public void strategy(BaseWsMonitorEventDTO<String> baseWsMonitorEventDTO) {
        ...
        streageService.handleBigScreenCountData(baseWsMonitorEventDTO);
    }
