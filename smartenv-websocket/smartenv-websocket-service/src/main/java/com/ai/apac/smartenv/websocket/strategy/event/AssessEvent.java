 ...
 */
@Component
public class AssessEvent extends BaseWebsocketPushStrategy {
    ...
    public String getSupportEventType() {
        return WsMonitorEventConstant.EventType.ASSESS_EVENT;
    }
    ...
    public void strategy(BaseWsMonitorEventDTO baseWsMonitorEventDTO) {
        ...
        streageService.handleHomeLast10Event(baseWsMonitorEventDTO);
        streageService.handleBigScreenEventCountByType(baseWsMonitorEventDTO);
