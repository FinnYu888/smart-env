 ...
 */
@Component
public class OrderInfoEvent extends BaseWebsocketPushStrategy {
    ...
    public String getSupportEventType() {
        return WsMonitorEventConstant.EventType.ORDER_EVENT;
    }

    @Override
    public void strategy(BaseWsMonitorEventDTO baseWsMonitorEventDTO) {
        streageService.handleHomeLast6Order(baseWsMonitorEventDTO);
