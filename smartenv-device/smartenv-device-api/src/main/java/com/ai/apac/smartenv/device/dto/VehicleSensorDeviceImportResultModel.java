...
public class VehicleSensorDeviceImportResultModel extends BaseRowModel implements Serializable {
    ...
    @ExcelProperty(value = "坐标类型" ,index = 6)
    private String coord;

    @ExcelProperty(value = "鉴权码" ,index = 7)
